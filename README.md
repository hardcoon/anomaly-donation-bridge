...
Для Windows x64. Версия программы — 1.0.70 Beta, аддона — 1.0.41.

## Установка

Скачайте [ZIP с программой](https://github.com/hardcoon/anomaly-donation-bridge/releases/download/v1.0.70-beta.1/AnomalyDonationBridge-1.0.70-beta.1-win-x64.zip),
