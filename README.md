...
Для Windows x64. Версия программы — 1.0.64 Beta, аддона — 1.0.35.

Изменения версии: [исправление группировки напарника и постоянных параметров](docs/RELEASE_1.0.64_BETA_RU.md).

## Установка

Скачайте [ZIP с программой](https://github.com/hardcoon/anomaly-donation-bridge/releases/download/v1.0.64-beta.1/AnomalyDonationBridge-1.0.64-beta.1-win-x64.zip),
...
включения или остановки обработки и для повтора последнего доната. Они работают
поверх игры; повтор снова запускает все активные пресеты, подходящие к сумме и
валюте последнего поступления.

Кнопка **Профили** создаёт независимые заготовки из пользовательских пресетов и
активных вариантов с суммами. Это позволяет быстро переключать стиль игры, не
затрагивая подключение DonationAlerts, очередь, историю и общие настройки.
