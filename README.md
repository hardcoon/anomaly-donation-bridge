...
Для Windows x64. Версия программы — 1.0.65 Beta, аддона — 1.0.36.

Изменения версии: [новые пресеты, компактный список, горячие клавиши и «Колесо фортуны»](docs/RELEASE_1.0.65_BETA_RU.md).

## Установка

Скачайте [ZIP с программой](https://github.com/hardcoon/anomaly-donation-bridge/releases/download/v1.0.65-beta.1/AnomalyDonationBridge-1.0.65-beta.1-win-x64.zip),
...
Во вкладках **Активные** и **Пользовательские пресеты** переключатель
**Компактно** показывает по одному пресету в строке: номер, название, первую
сумму, кнопку теста и меню **⋯**.
