...
Для Windows x64. Версия программы — 1.0.60 Beta, аддона — 1.0.31.

Изменения версии: [постоянная смена группировки игрока](docs/RELEASE_1.0.60_BETA_RU.md).

## Установка

Скачайте [ZIP с программой](https://github.com/hardcoon/anomaly-donation-bridge/releases/download/v1.0.60-beta.1/AnomalyDonationBridge-1.0.60-beta.1-win-x64.zip),
